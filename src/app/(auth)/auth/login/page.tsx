      ...
      <Card className="w-full max-w-md mx-4">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-white px-2 text-muted-foreground">Sample Test Accounts</span>
            </div>
          </div>

          <div className="text-center text-sm text-muted-foreground bg-blue-50 p-3 rounded">
            <div className="font-medium text-blue-900 mb-1">Use these for testing:</div>
            <div className="text-xs space-y-1">
              <div>📧 <span className="font-mono">sarah.chen@example.com</span></div>
              <div>📧 <span className="font-mono">michael.johnson@example.com</span></div>
              <div className="mt-2 text-blue-700">🔑 Password: any text works</div>
            </div>
          </div>
